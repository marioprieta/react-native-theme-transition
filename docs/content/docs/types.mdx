---
title: Types
description: Every TypeScript type exported by the library, with field-level reference.
---
...
`'light'` and `'dark'`. See
[createThemeTransition](/docs/api/create-theme-transition#systemthememap).

## `ThemeTransitionConfig`

Configuration for `createThemeTransition`. The full table lives at
[Create theme transition / Arguments](/docs/api/create-theme-transition#arguments).
...
[theme vs preference decision table](/docs/api/use-theme#theme-vs-preference).
