---
title: Theme Toggle
description: A custom light/dark switch with transition-safe timing, built on plain React styles.
---
...
<Callout type="warn">
  Don't use the native React Native `<Switch>` for theme toggling.
...
applies to the [Theme Picker](/docs/examples/theme-picker) and the
[Checkmark List](/docs/examples/checkmark-list).

## See Also

- [Theme Picker](/docs/examples/theme-picker). Segmented control built around `preference`.
- [Theme Button](/docs/examples/theme-button). Minimal cycle-button without state.
