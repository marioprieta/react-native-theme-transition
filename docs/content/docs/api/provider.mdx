...
- [createThemeTransition](/docs/api/create-theme-transition). Factory that produces this provider.
- [useTheme](/docs/api/use-theme). Hook for reading the current theme inside the tree.
- [Quick Start](/docs/quick-start). Minimal setup walkthrough.
