...
|---|---|---|
| `ThemeTransitionProvider` | `Component` | React provider that supplies animated theme colors via context. See [ThemeTransitionProvider](/docs/api/provider) for placement rules and nesting examples. |
