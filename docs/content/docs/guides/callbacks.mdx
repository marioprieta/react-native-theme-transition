---
title: Callbacks
description: When each lifecycle callback fires for animated, instant, system-driven, and failed transitions.
---
...
<Callout type="warn">
  `onTransitionEnd` does **not** fire on capture failure. Write
...
- [createThemeTransition](/docs/api/create-theme-transition#arguments). Config-level callbacks.
- [SetThemeOptions](/docs/types#setthemeoptions). Per-call callbacks.
